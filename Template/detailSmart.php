				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">APPLE iPhone 13 256 GB Rosé Dual SIM</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img">
							...
							<div class="product-preview">
								<img src="./img/iphone02.png" alt="">
							</div>

							<div class="product-preview">
								<img src="./img/iphone03.png" alt="">
							</div>

							<div class="product-preview">
								<img src="./img/iphone04.png" alt="">
							</div>
							
							<div class="product-preview">
								<img src="./img/iphone05.png" alt="">
							</div>
							
							<div class="product-preview">
								<img src="./img/iphone06.png" alt="">
							</div>
						</div>
					</div>
					<!-- /Product main img -->
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name">APPLE iPhone 13 256 GB Rosé Dual SIM</h2>
							<!--div>
							...
							<div>
								<h3 class="product-price">€800.00 <del class="product-old-price">€1019.00</del></h3>
								<span class="product-available">auf Lager</span>
							</div>
							<p>iPhone 13. Das fortschrittlichste Zwei-Kamera-System, das es je auf einem iPhone gab. Superschneller A15 Bionic Chip. Ein großer Sprung bei der Batterielaufzeit. Robustes Design. Superschnelles 5G. Und ein helleres Super Retina XDR Display.</p>
						...
						<div id="product-tab">
							...
							<div class="tab-content">
								...
								<div id="tab1" class="tab-pane fade in active">
									<div class="row">
										<div class="col-md-12">
											<p>Um unsere Umweltziele zu erreichen, kommen das iPhone 13 und das iPhone 13 mini ohne Netzteil und EarPods. Im Lieferumfang befindet sich ein USB‑C auf Lightning Kabel, das schnelles Aufladen unterstützt und mit USB‑C Netzteilen und Computeranschlüssen kompatibel ist.

Bitte verwende weiter deine vorhandenen USB-A auf Lightning Kabel, Netzteile und Kopfhörer, die mit diesen iPhone Modellen kompatibel sind. Solltest du ein neues Netzteil oder Kopfhörer von Apple benötigen, sind diese separat erhältlich. </p>
										</div>
									</div>
								</div>
								<!-- /tab1  -->
					...
					<div class="col-md-3 col-xs-6">
						<div class="product">
							...
							<div class="product-body">
								...
								<h3 class="product-name"><a href="#">APPLE MacBook Air</a></h3>
