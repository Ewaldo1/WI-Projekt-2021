<!--Benutz ihr diese Dokumente immer um unsere Header zu importieren --!>
...
<head>
    ...
    <head>
        ...
        <!-- Bootstrap -->
        <link type="text/css" rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/css/bootstrap.min.css"> <!-- Für Form Require -->
    ...
    <div id="top-header">
        <div class="container">
            ...
            <ul class="header-links pull-right">
                ...
                <li><a href="logout.php" class="btn btn-danger ">Abmelden</a></li>
            </ul>
        </div>
    </div>
    <!-- /TOP HEADER -->
